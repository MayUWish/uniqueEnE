    ...
    return (
        ...
        <div style={{ margin:'auto 3%' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end'}}>
                <NavLink style={{ display: 'block', color:'#183a1d',textDecoration: 'none', border: '1px solid lightgray', fontWeight: 'bold' }} to={`/hosting/${listingId}/images`}>Show all photos </NavLink>
            </div>
